...
pa_value_t* __open(pa_value_t* args, pa_value_t* kwargs) {
...
pa_value_t* __close(pa_value_t* args, pa_value_t* kwargs) {
...
pa_value_t* __read(pa_value_t* args, pa_value_t* kwargs) {
    pa_value_t* handle = pa_get_argument(args, kwargs, 0, "handle", pa_new_nil());
...
pa_value_t* __write(pa_value_t* args, pa_value_t* kwargs) {
    pa_value_t* handle = pa_get_argument(args, kwargs, 0, "handle", pa_new_nil());
